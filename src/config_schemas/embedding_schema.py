...
class BedrockEmbeddingConfig(EmbeddingConfig):
    _target_: str = "embeddings.models.BedrockEmbedding"
...
class HuggingFaceEmbeddingConfig(EmbeddingConfig):
    _target_: str = "embeddings.models.HuggingFaceEmbedding"
...
class OpenAIEmbeddingConfig(EmbeddingConfig):
    _target_: str = "embeddings.models.OpenAIEmbedding"
...
def setup_config() -> None:
    ...
    cs.store(
        name="bedrock_embedding_schema",
        group="embedding",
        node=BedrockEmbeddingConfig
    )

    cs.store(
        name="huggingface_embedding_schema",
        group="embedding",
        node=HuggingFaceEmbeddingConfig
    )

    cs.store(
        name="openai_embedding_schema",
        group="embedding",

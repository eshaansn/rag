...
class BedrockEmbeddingConfig(EmbeddingConfig):
    _target_: str = "models.embedding_models.BedrockEmbedding"
...
class HuggingFaceEmbeddingConfig(EmbeddingConfig):
    _target_: str = "models.embedding_models.HuggingFaceEmbedding"
...
class OpenAIEmbeddingConfig(EmbeddingConfig):
    _target_: str = "models.embedding_models.OpenAIEmbedding"
